...
class ReLoginOTP : AppCompatActivity(), View.OnClickListener {
    ...
    private fun reLogin(uid: String) {
        db!!.collection("User").document(uid).get()
            ...
            .addOnFailureListener {
                Toast.makeText(
                    this@ReLoginOTP,
                    "This number is not registered and please create your account with this number.",
                    Toast.LENGTH_SHORT
                ).show()
            }
    }
